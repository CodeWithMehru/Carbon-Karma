  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
      ...
      if (result?.error) {
        ...
        toast({ title: 'Verification Email Sent', description: 'Please verify your email to get started.', type: 'success' });
    ...
    <main id="main-content" className="flex-1 flex items-center justify-center min-h-screen relative overflow-hidden bg-gradient-to-br from-emerald-50 via-[#f0fdf4] to-amber-50 py-12 px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-1.5 text-sm text-emerald-700">Join thousands reducing their footprint in India</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-emerald-100 overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-6 border-b border-emerald-50">
            <h1 className="text-2xl font-bold text-emerald-950 font-heading text-center">Create your account</h1>
            <p className="text-sm text-emerald-600 text-center mt-1">Sign up and earn your first 100 Karma points</p>
          </div>
          ...
          <div className="px-8 py-6 space-y-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <Label htmlFor="fullName" className="text-emerald-900 font-medium text-sm">Full Name</Label>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-emerald-500">Must be at least 8 characters with one uppercase letter and one number.</p>
              </div>
