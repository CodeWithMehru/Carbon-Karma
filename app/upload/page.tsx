...
export default function UploadPage() {
  ...
  return (
    <div
      ...
      className="min-h-screen bg-[#f0fdf4] py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden"
    >
      {/* Decorative */}
      <div
        className="absolute top-[-10%] right-[-10%] w-[40%] h-[40%] bg-emerald-100 rounded-full blur-3xl opacity-40 animate-pulse-glow"
      ...
      <div className="max-w-3xl mx-auto z-10 relative">
        ...
        <div aria-live="polite" className="sr-only">
          ...
          {parsedData && !isConfirming
            ? `AI analysis complete. Review the ${parsedData.items.length} items found.`
            : ''}
            ...
            >
              <Card className="glass border-border/50 shadow-xl backdrop-blur-md">
                <CardHeader>
                  ...
                  <CardDescription>
                    Upload a picture of a grocery receipt, fuel bill, or sustainable product. Our AI
                    will automatically estimate its carbon footprint.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                      ...
                      <CardDescription className="mt-1">
                        Found {parsedData.items.length} items at{' '}
                        <strong>{parsedData.store_name}</strong> (Total: ₹{parsedData.total_inr})
                      </CardDescription>
                    </div>
                    ...
                    <div className="flex flex-col items-end">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold">
                          {parsedData.overall_sustainability_score}/100
                        </span>
                      </div>
                    </div>
                  </div>
