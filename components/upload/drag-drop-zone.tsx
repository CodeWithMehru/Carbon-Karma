      ...
      <AnimatePresence mode="wait">
        {!selectedFile ? (
          <motion.div
            ...
            className={cn(
              ...
              isDragActive
                ...
                : 'border-border hover:bg-emerald-50/30 hover:border-emerald-300',
          ...
          >
            <div
              {...getRootProps()}
              className="w-full h-full flex flex-col items-center justify-center text-center cursor-pointer p-8 outline-none"
            >
              <input {...getInputProps()} />
          ...
          >
            ...
            <div className="flex-1 text-center sm:text-left">
              <div className="flex items-center justify-center sm:justify-start gap-2 mb-2">
                ...
                <h4 className="font-medium text-emerald-950 truncate max-w-[200px]">
                  {selectedFile.name}
                </h4>
              </div>
